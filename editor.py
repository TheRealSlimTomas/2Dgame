...
platform_x_img = pygame.image.load('img/platform2.png')
platform_y_img = pygame.image.load('img/platform1.png')
lava_img = pygame.image.load('img/lava.jpg')
coin_img = pygame.image.load('img/coin1.png')
exit_img = pygame.image.load("img/exitdoor1.png.")
